...
export default function EducationSlugError({
  error,
  reset,
}: {
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        <p className="font-mono text-xs tracking-widest uppercase text-muted-foreground mb-4">Education</p>
        <h1 className="text-3xl font-bold text-foreground mb-3">Pagina niet gevonden</h1>
        <p className="text-muted-foreground mb-8">
          Deze cursuspagina bestaat niet of kon niet worden geladen.
        </p>
