...
import { FinanceCalc } from './_components/calc'
...
const NL = {
  ...
  calculator: {
    ...
    title: 'Wat kost dit — en aan wie',
    subtitle:
      'Twee kanten. Het abonnement betaalt het kantoor zelf aan Anthropic. Jouw omzet is de begeleiding: scope-gedreven uren × jouw uurtarief, met een optionele doorlopende ondersteuning.',
    calcLabels: {
      ...
      rateHint: 'Instelbaar · zet dit op wat je marge en de markt vragen',
      supHint: 'Optioneel retainer na livegang — terugkerende omzet',
      billingLabel: 'Seat-facturatie',
      clientHeader: 'Het kantoor zelf · abonnement aan Anthropic',
      suriHeader: 'Suritargets · eenmalige begeleiding',
      ...
      perMonth: 'Per maand',
      perYear: 'Per jaar',
      totalLabel: 'Suritargets-omzet · jaar 1',
      totalNote1: 'begeleiding eenmalig',
      totalNote2: 'ondersteuning',
      clientNote: 'Abonnement (Anthropic — niet jouw omzet)',
      firstYear: 'Totaal voor het kantoor · jaar 1',
      ...
      cautionBody:
        'Het abonnement betaalt het kantoor zelf — rechtstreeks aan Anthropic, in US$, regel een internationale betaalmethode. · Het 5-seat-minimum: een kantoor van 2 of 3 betaalt toch voor 5 seats. · Jouw tarief en marge: de begeleiding is eenmalig; een doorlopende ondersteuning houdt het terugkerend.',
    },
  },
  rollout: {
...
const EN: typeof NL = {
  ...
  calculator: {
    ...
    title: 'What does this cost — and to whom',
    subtitle:
      "Two sides. The subscription the firm pays directly to Anthropic. Your revenue is the guidance: scope-driven hours × your hourly rate, with optional ongoing support.",
    calcLabels: {
      premSeats: 'Premium seats',
      stdSeats: 'Standard seats',
      ...
      rateHint: 'Adjustable · set this to what your margin and market require',
      supHint: 'Optional retainer after go-live — recurring revenue',
      billingLabel: 'Seat billing',
      clientHeader: 'The firm itself · subscription to Anthropic',
      suriHeader: 'Suritargets · one-off guidance',
      ...
      perMonth: 'Per month',
      perYear: 'Per year',
      totalLabel: 'Suritargets revenue · year 1',
      totalNote1: 'guidance one-off',
      totalNote2: 'support',
      clientNote: 'Subscription (Anthropic — not your revenue)',
      firstYear: 'Total for the firm · year 1',
      seatWarn1: 'min. 5 seats',
      ...
      cautionBody:
        'The subscription is paid directly to Anthropic in US$ — arrange an international payment method. · The 5-seat minimum: a firm of 2 or 3 still pays for 5 seats. · Your rate and margin: guidance is one-off; ongoing support makes it recurring.',
    },
  },
  rollout: {
    ...
    <>
      ...
      <section className="px-(--section-padding-x) py-(--section-padding-y) border-b border-border">
        <div className="max-w-360 mx-auto">
          ...
          <AnimatedSection delay={60}>
            <div className="mt-8">
              <FinanceCalc labels={c.calculator.calcLabels} />
            </div>
          </AnimatedSection>
        </div>
      </section>
