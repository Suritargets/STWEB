    ...
    <div className="min-h-screen">
      ...
      <div className="px-[var(--section-padding-x)] pt-8 max-w-[1440px] mx-auto">
        <nav aria-label="breadcrumb" className="flex items-center gap-2 text-xs font-mono text-muted-foreground">
          ...
          <span>/</span>
          <Link href="/case-studies" className="hover:text-gold transition-colors">Cases</Link>
          <span>/</span>
      ...
      <section className="px-[var(--section-padding-x)] py-16 border-t border-border">
        <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h2 className="text-2xl font-bold text-foreground">Soortgelijke resultaten voor uw organisatie?</h2>
          ...
          <div className="flex gap-4">
            ...
            <CtaButton href="/case-studies" variant="ghost">Meer cases</CtaButton>
          </div>
        </div>
      </section>
    </div>
